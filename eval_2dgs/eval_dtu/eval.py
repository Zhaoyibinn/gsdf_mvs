...
def main_eval(args_eval):
    ...
    args = Args(data="data_in.ply", scan=1,mode=f"mesh",dataset_dir=".",vis_out_dir=".",downsample_density = 0.2 , patch_size = 60, max_dist = 20 , visualize_threshold = 10)
    
    args.data = args_eval.data
    args.scan = args_eval.scan
    args.dataset_dir = args_eval.dataset_dir
    args.vis_out_dir = args_eval.vis_out_dir
    args.mode = args_eval.mode
